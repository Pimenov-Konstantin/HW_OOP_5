public class Parser {
    ...
    public Parser(String[] complexOperand) {
        ...
        ComplexNumber complexNumber1 = new ComplexNumber(Double.parseDouble(s1[0]), Double.parseDouble(s1[2]));
        ComplexNumber complexNumber2 = new ComplexNumber(Double.parseDouble(s2[0]), Double.parseDouble(s2[2]));
